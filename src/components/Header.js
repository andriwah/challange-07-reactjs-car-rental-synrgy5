          ...
          <nav className="navbar navbar-expand-lg navbar-light">
            <div className="container-fluid">
              <div className="navbar-brand">
                <Link to={`/`} style={{ textDecoration: 'none', color: 'black' }} onClick={toggleButtonHandler}>
                  <img src="images/logo.png" width="100px" alt="social-icon" />
                </Link>
              </div>
                ...
                <div className="offcanvas-body justify-content-end" id="offcanvasRight">
                  <ul className="navbar-nav mb-2 mb-lg-0 gap-4">
                    <li className="nav-item">
                      <a href="#ourservices" className="nav-link btn-outline-theme">
                        Our Services
                      </a>
                    </li>
                    <li className="nav-item">
                    ...
                    <li className="nav-item">
                      <a href="#testimonial" className="nav-link btn-outline-theme">
                        Testimonial
                      </a>
                    </li>
                    <li className="nav-item">
                    ...
                    <li className="nav-item">
                      <a href="register.html" className="nav-link btn btn-color-theme pl-3 pr-3">
                        Register
                      </a>
                    </li>
                  </ul>
